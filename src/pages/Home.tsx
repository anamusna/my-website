...
const SlideContentWrapper = () => {
  ...
  return (
    <SlideContent
      className="d-flex flex-column align-items-center justify-content-center align-items-md-end justify-content-md-end pb-5"
      from="left"
      slideElement={
        <div className="col-12">
          ...
          <div className="mt-md-auto mb-md-4">
            <p className="home-hero-text body-text fw-normal mb-4">
              {t("home.hero.text")}
            </p>
            <div className="">
              <Link
                className="btn btn-gradient text-uppercase text-start"
                to="/about"
              >
                {t("about.title")}
                <FontAwesomeIcon
          ...
          <div className="hero-row row">
            <div className="mx-auto">
              <div className="d-flex flex-column mt-4 mb-4 mx-auto">
                ...
                <p className="body-text text-start mb-4">
                  {t("process.subText")}
  ...
  return (
    <div className="">
      <div className="container py-5 py-md-6">
        ...
        <div className="col-12 col-md-10 mx-auto mb-4 mb-md-0">
          <CarouselComponent
