...
const TimelineCard: React.FC<{
  ...
  return (
    <div
      className={`${SURFACE_CARD_INTERACTIVE} dark:bg-dark-background relative min-h-[140px] sm:min-h-[160px] p-3 sm:p-4 border-indigo-200/40 dark:border-indigo-500/25 hover:border-indigo-400/50 dark:hover:border-indigo-400/40`}
    >
...
const Journey: React.FC<JourneyProps> = ({ hideHeader = false }) => (
  ...
  >
    <div className="container max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 relative z-10">
      {!hideHeader && (
        <SectionHeader
          badge={{
            text: "My Path",
          ...
          description="My career has been a journey of curiosity, learning, and building. From IT to full-stack development, I've focused on creating systems that aren't just functional, but fast, reliable, and genuinely helpful to the people using them."
          highlightText="creating systems that aren't just functional, but fast, reliable, and genuinely helpful to the people using them"
        />
      )}
