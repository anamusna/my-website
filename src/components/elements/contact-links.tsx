...
const ContactLinks: React.FC = () => {
  return (
    <div
      className={`${SURFACE_CARD_BASE} dark:bg-dark-background relative p-4 sm:p-5 lg:p-4 rounded-2xl border border-light-border/55 dark:border-dark-border/40`}
    >
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-2">
        ...
        <ContactLinkButton
          ...
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/ansumana-darboe/",
              "_blank",
            )
          }
        />
